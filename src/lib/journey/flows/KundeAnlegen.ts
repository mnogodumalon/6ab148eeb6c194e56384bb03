...
export type KundeAnlegenFieldKey = 'ansprechpartner_email' | 'ansprechpartner_nachname' | 'ansprechpartner_titel' | 'ansprechpartner_vorname' | 'bevorzugte_kontaktart' | 'email' | 'hausnummer' | 'kundenname' | 'kundentyp' | 'notizen' | 'ort' | 'plz' | 'rechnungsadresse_gleich' | 'rechnungshausnummer' | 'rechnungsort' | 'rechnungsplz' | 'rechnungsstrasse' | 'strasse';
...
export function useKundeAnlegenFlow(options: KundeAnlegenFlowOptions = {}) {
  ...
  return {
    ...
    form: kunden,
    forms, formList, picks, submit, steps,    reviewStep: KUNDEANLEGEN_REVIEW_STEP,
