 ...
 *
 * Writes `projekte`: asks `kunde`, `projektart`, `projektstart_jahr`, `projektstart_monat`, `ansprechpartner_kunde`, `projektleitung`, `letzter_schritt`; sets `projektstatus` itself.
 ...
 *     steps: { kunde: 1, projektleitung: 2, projektart: 3, projektstart_jahr: 3, projektstart_monat: 3, ansprechpartner_kunde: 3, letzter_schritt: 3 },
...
export function useProjektAnlegenFlow(options: ProjektAnlegenFlowOptions = {}) {
  ...
  const projekte = useStepForm('projekte', {
    fields: ["kunde", "projektart", "projektstart_jahr", "projektstart_monat", "ansprechpartner_kunde", "projektleitung", "letzter_schritt"],
    steps: only(steps, ["kunde", "projektart", "projektstart_jahr", "projektstart_monat", "ansprechpartner_kunde", "projektleitung", "letzter_schritt"]) as Record<string, number>,
