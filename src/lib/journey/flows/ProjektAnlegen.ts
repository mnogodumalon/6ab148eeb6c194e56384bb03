 ...
 *
 * Writes `projekte`: asks `kunde`, `projektart`, `projektstart_monat`, `projektstart_jahr`, `projektleitung`, `ansprechpartner_kunde`, `letzter_schritt`; sets `projektstatus` itself.
...
export function useProjektAnlegenFlow(options: ProjektAnlegenFlowOptions = {}) {
  ...
  const projekte = useStepForm('projekte', {
    fields: ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt"],
    steps: only(steps, ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt"]) as Record<string, number>,
    ...
    initial: only(options.initial as FormValues | undefined, ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt"]),
    messages: only(options.messages as Record<string, string> | undefined, ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt"]),
  });
