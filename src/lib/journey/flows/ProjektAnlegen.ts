...
const DEFAULT_STEPS: Record<string, number> = {"ansprechpartner_kunde": 3, "kunde": 1, "letzter_schritt": 3, "projektart": 3, "projektkennung": 3, "projektleitung": 2, "projektstart_jahr": 3, "projektstart_monat": 3};
...
export function useProjektAnlegenFlow(options: ProjektAnlegenFlowOptions = {}) {
  ...
  const projekte = useStepForm('projekte', {
    fields: ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt", "projektkennung"],
    steps: only(steps, ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt", "projektkennung"]) as Record<string, number>,
    initial: only(options.initial as FormValues | undefined, ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt", "projektkennung"]),
    messages: only(options.messages as Record<string, string> | undefined, ["kunde", "projektart", "projektstart_monat", "projektstart_jahr", "projektleitung", "ansprechpartner_kunde", "letzter_schritt", "projektkennung"]),
  });
  ...
  const picks = {
    ...
    projektleitung: { ...searches.projektleitung, select: { ...searches.projektleitung.select, create: true as boolean } },
  };
