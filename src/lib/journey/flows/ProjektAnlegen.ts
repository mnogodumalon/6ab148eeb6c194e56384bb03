 ...
 *
 * Writes `projekte`: asks `projektart`, `projektstart_monat`, `projektstart_jahr`, `kunde`, `ansprechpartner_kunde`, `projektleitung`, `letzter_schritt`; sets `projektstatus` itself.
...
export function useProjektAnlegenFlow(options: ProjektAnlegenFlowOptions = {}) {
  ...
  const projekte = useStepForm('projekte', {
    fields: ["projektart", "projektstart_monat", "projektstart_jahr", "kunde", "ansprechpartner_kunde", "projektleitung", "letzter_schritt"],
    steps: only(steps, ["projektart", "projektstart_monat", "projektstart_jahr", "kunde", "ansprechpartner_kunde", "projektleitung", "letzter_schritt"]) as Record<string, number>,
    ...
    initial: only(options.initial as FormValues | undefined, ["projektart", "projektstart_monat", "projektstart_jahr", "kunde", "ansprechpartner_kunde", "projektleitung", "letzter_schritt"]),
    messages: only(options.messages as Record<string, string> | undefined, ["projektart", "projektstart_monat", "projektstart_jahr", "kunde", "ansprechpartner_kunde", "projektleitung", "letzter_schritt"]),
  });
