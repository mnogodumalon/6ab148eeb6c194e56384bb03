 ...
 *             but leaves the rule to you: `erfassungsmonat` (derived:computed:Monat des eingegebenen Datums als Abrechnungsmonat-Schlüssel (z.B. 'januar')), `erfassungsjahr` (derived:computed:Jahr des eingegebenen Datums als vierstellige Zahl) *
...
export interface ZeitBuchenFlowOptions {
  ...
  compute: {
    erfassungsmonat: (forms: ZeitBuchenForms) => unknown;   // derived:computed:Monat des eingegebenen Datums als Abrechnungsmonat-Schlüssel (z.B. 'januar')
    erfassungsjahr: (forms: ZeitBuchenForms) => unknown;   // derived:computed:Jahr des eingegebenen Datums als vierstellige Zahl
  };
}
