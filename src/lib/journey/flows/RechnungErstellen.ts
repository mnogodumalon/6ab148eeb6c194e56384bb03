...
export function useRechnungErstellenFlow(options: RechnungErstellenFlowOptions = {}) {
  ...
  const rechnungen = useStepForm('rechnungen', {
    ...
    required: { berater: true, faelligkeitsdatum: true, gesamtbetrag: true, kunde: true, mehrwertsteuer: true, nettobetrag: true, notizen: true, projekt: true, zeiterfassungseintraege: true },
