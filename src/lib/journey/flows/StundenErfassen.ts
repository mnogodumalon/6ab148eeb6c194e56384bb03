 ...
 *             but leaves the rule to you: `erfassungsmonat` (derived:computed:Monat des eingegebenen Datums als Lookup-Option), `erfassungsjahr` (derived:computed:Jahr des eingegebenen Datums) *
...
export interface StundenErfassenFlowOptions {
  ...
  compute: {
    erfassungsmonat: (forms: StundenErfassenForms) => unknown;   // derived:computed:Monat des eingegebenen Datums als Lookup-Option
    erfassungsjahr: (forms: StundenErfassenForms) => unknown;   // derived:computed:Jahr des eingegebenen Datums
  };
}
...
export function useStundenErfassenFlow(options: StundenErfassenFlowOptions) {
  ...
  return {
    ...
    reviewStep: STUNDENERFASSEN_REVIEW_STEP,
