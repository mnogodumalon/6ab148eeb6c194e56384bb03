 ...
 *             but leaves the rule to you: `erfassungsmonat` (derived:computed:Monat aus dem eingegebenen Datum als Schlüssel (z. B. 'januar')), `erfassungsjahr` (derived:computed:Jahr aus dem eingegebenen Datum als vierstellige Zahl) *
...
export type StundenErfassenFieldKey = 'abrechenbar' | 'berater' | 'datum' | 'leistung' | 'projekt' | 'stunden' | 'taetigkeit';
...
export interface StundenErfassenFlowOptions {
  ...
  compute: {
    erfassungsmonat: (forms: StundenErfassenForms) => unknown;   // derived:computed:Monat aus dem eingegebenen Datum als Schlüssel (z. B. 'januar')
    erfassungsjahr: (forms: StundenErfassenForms) => unknown;   // derived:computed:Jahr aus dem eingegebenen Datum als vierstellige Zahl
  };
}
...
export function useStundenErfassenFlow(options: StundenErfassenFlowOptions) {
  ...
  const picks = {
    berater: { ...searches.berater, select: { ...searches.berater.select, create: true as boolean } },
    projekt: { ...searches.projekt, select: { ...searches.projekt.select, create: false as boolean } },
    leistung: { ...searches.leistung, select: { ...searches.leistung.select, create: false as boolean } },
  };
