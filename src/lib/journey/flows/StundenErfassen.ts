 ...
 *             but leaves the rule to you: `erfassungsmonat` (derived:computed:Kalendermonat des eingegebenen Datums als Lookup-Schlüssel), `erfassungsjahr` (derived:computed:Kalenderjahr des eingegebenen Datums) *
...
export interface StundenErfassenFlowOptions {
  ...
  compute: {
    erfassungsmonat: (forms: StundenErfassenForms) => unknown;   // derived:computed:Kalendermonat des eingegebenen Datums als Lookup-Schlüssel
    erfassungsjahr: (forms: StundenErfassenForms) => unknown;   // derived:computed:Kalenderjahr des eingegebenen Datums
  };
}
