...
export function useStundenBuchenFlow(options: StundenBuchenFlowOptions = {}) {
  ...
  const zeiterfassung = useStepForm('zeiterfassung', {
    fields: ["berater", "projekt", "leistung", "datum", "stunden", "taetigkeit", "erfassungsmonat", "erfassungsjahr", "abrechenbar"],
    steps: only(steps, ["berater", "projekt", "leistung", "datum", "stunden", "taetigkeit", "erfassungsmonat", "erfassungsjahr", "abrechenbar"]) as Record<string, number>,
    initial: only(options.initial as FormValues | undefined, ["berater", "projekt", "leistung", "datum", "stunden", "taetigkeit", "erfassungsmonat", "erfassungsjahr", "abrechenbar"]),
    messages: only(options.messages as Record<string, string> | undefined, ["berater", "projekt", "leistung", "datum", "stunden", "taetigkeit", "erfassungsmonat", "erfassungsjahr", "abrechenbar"]),
  });
