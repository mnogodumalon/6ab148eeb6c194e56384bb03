...
export type KundenAnlegenFieldKey = 'ansprechpartner_email' | 'ansprechpartner_nachname' | 'ansprechpartner_titel' | 'ansprechpartner_vorname' | 'bevorzugte_kontaktart' | 'email' | 'hausnummer' | 'kundenname' | 'kundentyp' | 'ort' | 'plz' | 'rechnungsadresse_gleich' | 'rechnungshausnummer' | 'rechnungsort' | 'rechnungsplz' | 'rechnungsstrasse' | 'strasse';
