 ...
 *             but leaves the rule to you: `angebotsjahr` (derived:computed:Aktuelles Kalenderjahr zum Zeitpunkt der Erstellung) *
...
export interface AngebotErstellenFlowOptions {
  ...
  compute: {
    angebotsjahr: (forms: AngebotErstellenForms) => unknown;   // derived:computed:Aktuelles Kalenderjahr zum Zeitpunkt der Erstellung
  };
}
