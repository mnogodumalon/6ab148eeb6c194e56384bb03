 ...
 *             but leaves the rule to you: `angebotsjahr` (derived:computed:Aktuelles Jahr zum Zeitpunkt der Erstellung) *
...
export interface AngebotErstellenFlowOptions {
  ...
  compute: {
    angebotsjahr: (forms: AngebotErstellenForms) => unknown;   // derived:computed:Aktuelles Jahr zum Zeitpunkt der Erstellung
  };
}
