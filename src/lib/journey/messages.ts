...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  angebote: { angebotsnummer: "Bitte die Angebotsnummer eingeben.", angebotsjahr: "Bitte das Jahr eingeben.", angebotstyp: "Bitte den Angebotstyp auswählen.", zeitrahmen_anfang: "Bitte den Beginn des Zeitrahmens angeben." },
  ...
  rechnungen: { rechnungsnummer: "Bitte die Rechnungsnummer eingeben.", rechnungsdatum: "Bitte das Rechnungsdatum angeben.", kunde: "Bitte einen Kunden auswählen.", projekt: "Bitte ein Projekt auswählen.", nettobetrag: "Bitte den Nettobetrag eingeben.", mehrwertsteuer: "Bitte den Mehrwertsteuerbetrag eingeben.", rechnungsjahr: "Bitte das Abrechnungsjahr eingeben." },
  // </custom:messages>
};
