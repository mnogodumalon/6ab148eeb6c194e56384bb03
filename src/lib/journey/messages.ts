...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  angebote: { angebotsnummer: "Bitte die Angebotsnummer eingeben.", angebotsjahr: "Bitte das Angebotsjahr eingeben.", angebotstyp: "Bitte den Angebotstyp auswählen.", zeitrahmen_anfang: "Bitte den Beginn des Zeitrahmens wählen." },
  zeiterfassung: { berater: "Bitte eine Berater:in auswählen.", projekt: "Bitte ein Projekt auswählen.", datum: "Bitte das Datum der Tätigkeit wählen.", stunden: "Bitte die Anzahl der Stunden eingeben." },
  rechnungen: { rechnungsnummer: "Bitte die Rechnungsnummer eingeben.", rechnungsdatum: "Bitte das Rechnungsdatum wählen.", kunde: "Bitte einen Kunden auswählen.", nettobetrag: "Bitte den Nettobetrag eingeben.", mehrwertsteuer: "Bitte den Mehrwertsteuersatz eingeben.", projekt: "Bitte ein Projekt auswählen." },
  // </custom:messages>
};
