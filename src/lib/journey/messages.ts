...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  // <custom:messages>
  kunden: { kundenname: "Bitte den Namen oder Firmennamen eingeben.", kundentyp: "Bitte einen Kundentyp auswählen.", email: "Bitte die E-Mail-Adresse eingeben.", anlagedatum: "Bitte das Anlagedatum eingeben.", strasse: "Bitte die Straße eingeben.", hausnummer: "Bitte die Hausnummer eingeben.", plz: "Bitte die Postleitzahl eingeben.", ort: "Bitte den Ort eingeben." },
  berater: { vorname: "Bitte den Vornamen eingeben.", nachname: "Bitte den Nachnamen eingeben.", email_beruflich: "Bitte die berufliche E-Mail-Adresse eingeben.", status: "Bitte einen Status auswählen." },
  leistungskatalog: { leistungsname: "Bitte den Leistungsnamen eingeben.", leistungstyp: "Bitte einen Leistungstyp auswählen." },
  projekte: { projektkennung: "Bitte die Projektkennung eingeben.", projektart: "Bitte die Projektart auswählen.", projektstatus: "Bitte einen Status auswählen.", kunde: "Bitte einen Kunden auswählen." },
  angebote: { angebotsnummer: "Bitte die Angebotsnummer eingeben.", angebotsjahr: "Bitte das Angebotsjahr eingeben.", angebotstyp: "Bitte den Angebotstyp auswählen.", zeitrahmen_anfang: "Bitte den Beginn des Zeitrahmens eingeben." },
  zeiterfassung: { berater: "Bitte einen Berater auswählen.", projekt: "Bitte ein Projekt auswählen.", datum: "Bitte das Datum eingeben.", stunden: "Bitte die Anzahl der Stunden eingeben." },
  rechnungen: { rechnungsnummer: "Bitte die Rechnungsnummer eingeben.", rechnungsdatum: "Bitte das Rechnungsdatum eingeben.", kunde: "Bitte einen Kunden auswählen.", nettobetrag: "Bitte den Nettobetrag eingeben.", mehrwertsteuer: "Bitte den Mehrwertsteuersatz eingeben.", projekt: "Bitte ein Projekt auswählen." },
  // </custom:messages>
};
