...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  berater: { vorname: "Bitte den Vornamen eingeben.", nachname: "Bitte den Nachnamen eingeben.", email_beruflich: "Bitte die berufliche E-Mail eingeben.", status: "Bitte den Status auswählen." },
  leistungskatalog: { leistungsname: "Bitte die Bezeichnung der Leistung eingeben.", leistungstyp: "Bitte den Leistungstyp auswählen." },
  ...
  angebote: { angebotsnummer: "Bitte die Angebotsnummer eingeben.", angebotsjahr: "Bitte das Jahr eingeben.", angebotstyp: "Bitte den Angebotstyp auswählen.", zeitrahmen_anfang: "Bitte das Startdatum wählen." },
