...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  // <custom:messages>
  kunden: { kundenname: "Bitte den Namen oder Firmennamen eingeben.", kundentyp: "Bitte den Kundentyp wählen.", email: "Bitte die E-Mail-Adresse eingeben.", anlagedatum: "Bitte das Anlagedatum wählen.", strasse: "Bitte die Straße eingeben.", hausnummer: "Bitte die Hausnummer eingeben.", plz: "Bitte die Postleitzahl eingeben.", ort: "Bitte den Ort eingeben." },
  berater: { vorname: "Bitte den Vornamen eingeben.", nachname: "Bitte den Nachnamen eingeben.", email_beruflich: "Bitte die berufliche E-Mail-Adresse eingeben.", status: "Bitte den Status wählen." },
  leistungskatalog: { leistungsname: "Bitte den Leistungsnamen eingeben.", leistungstyp: "Bitte den Leistungstyp wählen." },
  projekte: { projektkennung: "Bitte die Projektkennung eingeben.", projektnummer: "Bitte die Projektnummer eingeben.", projektart: "Bitte die Projektart wählen.", projektstatus: "Bitte den Projektstatus wählen.", kunde: "Bitte einen Kunden auswählen." },
  angebote: { angebotsnummer: "Bitte die Angebotsnummer eingeben.", angebotsjahr: "Bitte das Angebotsjahr eingeben.", angebotstyp: "Bitte den Angebotstyp wählen.", zeitrahmen_anfang: "Bitte das Startdatum des Zeitrahmens wählen." },
  zeiterfassung: { berater: "Bitte eine Beraterin oder einen Berater auswählen.", projekt: "Bitte ein Projekt auswählen.", datum: "Bitte das Datum der Tätigkeit wählen.", stunden: "Bitte die Anzahl der Stunden eingeben." },
  rechnungen: { rechnungsnummer: "Bitte die Rechnungsnummer eingeben.", rechnungsdatum: "Bitte das Rechnungsdatum wählen.", kunde: "Bitte einen Kunden auswählen.", projekt: "Bitte ein Projekt auswählen.", nettobetrag: "Bitte den Nettobetrag eingeben.", mehrwertsteuer: "Bitte den Mehrwertsteuerbetrag eingeben.", rechnungsjahr: "Bitte das Abrechnungsjahr eingeben." },
  // </custom:messages>
};
