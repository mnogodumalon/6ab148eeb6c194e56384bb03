...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  projekte: { projektkennung: "Bitte die Projektkennung eingeben.", projektnummer: "Bitte die Projektnummer eingeben.", projektart: "Bitte die Projektart auswählen.", projektstatus: "Bitte den Projektstatus auswählen.", kunde: "Bitte einen Kunden auswählen." },
  angebote: { angebotsnummer: "Bitte die Angebotsnummer eingeben.", angebotsjahr: "Bitte das Jahr des Angebots eingeben.", angebotstyp: "Bitte den Angebotstyp auswählen.", zeitrahmen_anfang: "Bitte den Beginn des Zeitrahmens wählen." },
  zeiterfassung: { berater: "Bitte einen Berater auswählen.", projekt: "Bitte ein Projekt auswählen.", datum: "Bitte das Datum wählen.", stunden: "Bitte die Anzahl der Stunden eingeben." },
  rechnungen: { rechnungsnummer: "Bitte die Rechnungsnummer eingeben.", rechnungsdatum: "Bitte das Rechnungsdatum wählen.", kunde: "Bitte einen Kunden auswählen.", projekt: "Bitte ein Projekt auswählen." },
  // </custom:messages>
};
