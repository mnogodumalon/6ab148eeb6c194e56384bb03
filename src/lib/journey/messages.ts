...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  angebote: { angebotsnummer: "Bitte die Angebotsnummer eingeben.", angebotsjahr: "Bitte das Jahr eingeben.", angebotstyp: "Bitte einen Angebotstyp auswählen.", zeitrahmen_anfang: "Bitte das Startdatum eingeben." },
  zeiterfassung: { berater: "Bitte eine Berater:in auswählen.", projekt: "Bitte ein Projekt auswählen.", datum: "Bitte das Datum eingeben.", stunden: "Bitte die Anzahl der Stunden eingeben." },
  rechnungen: { rechnungsnummer: "Bitte die Rechnungsnummer eingeben.", rechnungsdatum: "Bitte das Rechnungsdatum eingeben.", kunde: "Bitte einen Kunden auswählen.", projekt: "Bitte ein Projekt auswählen." },
  // </custom:messages>
};
