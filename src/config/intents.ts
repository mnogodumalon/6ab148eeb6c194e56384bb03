...
// <custom:intent-imports>
import { IconFolderPlus, IconFileText, IconClock, IconReceipt, IconRefresh, IconFileCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/projekt-anlegen', label: { de: 'Projekt anlegen', en: 'Create Project' }, icon: IconFolderPlus, description: 'Legt ein neues Projekt an. Die Projektkennung wird automatisch aus Startjahr, Projektart-Kürzel und Projektnummer zusammengesetzt.' },
  { path: '/intents/angebot-erstellen', label: { de: 'Angebot erstellen', en: 'Create Offer' }, icon: IconFileText, description: 'Erstellt ein Angebot zu einem bestehenden Projekt. Nummer und Jahr werden automatisch vergeben. Das fertige Angebot wird als PDF generiert.' },
  { path: '/intents/stunden-buchen', label: { de: 'Stunden buchen', en: 'Log Hours' }, icon: IconClock, description: 'Berater:in bucht geleistete Stunden auf ein Projekt und eine Leistung.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create Invoice' }, icon: IconReceipt, description: 'Erstellt eine Rechnung auf Basis von Zeiterfassungseinträgen für einen Kunden und ein Projekt. Gesamtbetrag wird automatisch berechnet.' },
  { path: '/intents/projektstatus-aendern', label: { de: 'Projektstatus ändern', en: 'Change Project Status' }, icon: IconRefresh, description: 'Ändert den Status eines Projekts (z. B. von Akquise auf In Bearbeitung oder Abgeschlossen) und hält den letzten Stand fest.' },
  { path: '/intents/angebotsstatus-aendern', label: { de: 'Angebotsstatus aktualisieren', en: 'Update Offer Status' }, icon: IconFileCheck, description: 'Setzt den Status eines Angebots auf Versendet, Angenommen oder Abgelehnt.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-23T14:48:08+00:00';
