...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/angebot-erstellen', label: { de: 'Angebot erstellen', en: 'Create offer' }, icon: IconFileText, description: 'Erstellt ein neues Angebot zu einem Projekt, erfasst Typ, Zeitrahmen und Kosten.' },
  { path: '/intents/stunden-buchen', label: { de: 'Stunden buchen', en: 'Log hours' }, icon: IconClock, description: 'Erfasst geleistete Stunden eines Beraters auf ein Projekt und eine Leistung.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Erstellt eine neue Rechnung auf Basis eines Projekts und verknüpft Zeiterfassungseinträge und Berater.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-22T13:08:59+00:00';
