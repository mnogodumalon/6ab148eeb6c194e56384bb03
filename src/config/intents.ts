...
// <custom:intent-imports>
import { IconFolderPlus, IconFileDescription, IconClockPlus, IconReceipt } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/projekt-anlegen', label: { de: 'Projekt anlegen', en: 'Create project' }, icon: IconFolderPlus, description: 'Legt ein neues Projekt an, weist es einem Kunden zu, wählt Projektart, Projektleitung und Startdatum.' },
  { path: '/intents/angebot-erstellen', label: { de: 'Angebot erstellen', en: 'Create offer' }, icon: IconFileDescription, description: 'Erstellt ein neues Angebot zu einem bestehenden Projekt mit Angebotstyp, Zeitrahmen und Kosten.' },
  { path: '/intents/stunden-erfassen', label: { de: 'Stunden erfassen', en: 'Log hours' }, icon: IconClockPlus, description: 'Erfasst geleistete Stunden einer Berater:in für ein Projekt und eine Leistung.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Erstellt eine neue Rechnung auf Basis eines Projekts und Kunden, verknüpft Zeiterfassung und Berater:innen.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-23T12:14:35+00:00';
