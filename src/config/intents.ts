...
// <custom:intent-imports>
import { IconFolderPlus, IconFileText, IconClock, IconReceipt, IconRefresh, IconStatusChange } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/projekt-anlegen', label: { de: 'Projekt anlegen', en: 'Create project' }, icon: IconFolderPlus, description: 'Legt ein neues Projekt an und setzt die Projektkennung.' },
  { path: '/intents/angebot-anlegen', label: { de: 'Angebot anlegen', en: 'Create offer' }, icon: IconFileText, description: 'Erstellt ein neues Angebot zu einem Projekt im Status \'Entwurf\'.' },
  { path: '/intents/stunden-erfassen', label: { de: 'Stunden erfassen', en: 'Log hours' }, icon: IconClock, description: 'Bucht geleistete Stunden eines Beraters auf ein Projekt.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Erstellt eine neue Rechnung mit Zeiterfassungseinträgen im Status \'Entwurf\'.' },
  ...
  { path: '/intents/angebotsstatus-aendern', label: { de: 'Angebotsstatus aktualisieren', en: 'Update offer status' }, icon: IconStatusChange, description: 'Setzt den Status eines Angebots auf \'Versendet\', \'Angenommen\' oder \'Abgelehnt\'.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-24T12:59:18+00:00';
