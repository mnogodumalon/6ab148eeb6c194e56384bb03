...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/projekt-anlegen', label: { de: 'Projekt anlegen', en: 'Create project' }, icon: IconFolderPlus, description: 'Legt ein neues Projekt an, wählt den Kunden, die Projektart und die Projektleitung. Projektnummer und Projektkennung werden automatisch vergeben.' },
  { path: '/intents/angebot-erstellen', label: { de: 'Angebot erstellen', en: 'Create offer' }, icon: IconFileText, description: 'Erstellt ein neues Angebot zu einem bestehenden Projekt. Angebotsnummer wird automatisch vergeben.' },
  { path: '/intents/stunden-buchen', label: { de: 'Stunden buchen', en: 'Log hours' }, icon: IconClockPlus, description: 'Berater buchen geleistete Stunden auf ein Projekt und eine Leistungsart.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Erstellt eine neue Rechnung zu einem Projekt und einem Kunden. Zeiterfassungseinträge können zugeordnet werden.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-22T07:46:40+00:00';
