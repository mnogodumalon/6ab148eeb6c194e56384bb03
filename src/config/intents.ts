...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/projekt-anlegen', label: { de: 'Projekt anlegen', en: 'Create project' }, icon: IconFolderPlus, description: 'Legt ein neues Projekt an und verknüpft es mit einem Kunden sowie einer Projektleitung.' },
  { path: '/intents/angebot-erstellen', label: { de: 'Angebot erstellen', en: 'Create offer' }, icon: IconFileText, description: 'Erstellt ein neues Angebot zu einem bestehenden Projekt; die Angebotsnummer vergibt das System.' },
  { path: '/intents/stunden-buchen', label: { de: 'Stunden buchen', en: 'Log hours' }, icon: IconClockPlus, description: 'Erfasst geleistete Stunden eines Beraters auf ein Projekt und eine Leistung.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Erstellt eine neue Rechnung auf Basis eines Projekts und verknüpfter Zeiterfassungseinträge.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-22T14:49:17+00:00';
