...
// <custom:intent-imports>
import { IconFolderPlus, IconFileText, IconClockPlus, IconReceipt } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/projekt-anlegen', label: { de: 'Projekt anlegen', en: 'Create project' }, icon: IconFolderPlus, description: 'Legt ein neues Projekt an, wählt den Kunden und die Projektleitung aus und setzt den initialen Status auf \'Akquise\'.' },
  { path: '/intents/angebot-erstellen', label: { de: 'Angebot erstellen', en: 'Create offer' }, icon: IconFileText, description: 'Erstellt ein neues Angebot zu einem Projekt, erfasst Zeitrahmen, Kosten und Angebotstyp und setzt den Status auf \'Entwurf\'.' },
  { path: '/intents/stunden-erfassen', label: { de: 'Stunden erfassen', en: 'Record hours' }, icon: IconClockPlus, description: 'Berater erfassen ihre geleisteten Stunden auf ein Projekt und eine Leistung.' },
  { path: '/intents/rechnung-erstellen', label: { de: 'Rechnung erstellen', en: 'Create invoice' }, icon: IconReceipt, description: 'Erstellt eine neue Rechnung zu einem Projekt und Kunden, verknüpft Zeiterfassungseinträge und erfasst Netto und MwSt.' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-22T07:16:44+00:00';
