...
export const PLAN_SUMMARY = "inclou. ERP ist die zentrale Verwaltungsplattform der inclou. GmbH & Co. KG. Sie erfasst Kunden, Berater, Leistungen, Projekte, Angebote, Zeiterfassung und Rechnungen. Kernprozesse sind: Angebote mit automatischer Nummerierung und PDF-Generierung, Projektverwaltung mit strukturierter Kennung, monatliche Zeiterfassung der Berater und Rechnungsstellung auf Basis der erfassten Stunden.";
