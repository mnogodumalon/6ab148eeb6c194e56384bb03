...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    ...
    'faelligkeitsdatum',
    'rechnungsstatus',
    { row: ['rechnungsmonat', 'rechnungsjahr'], cols: '1fr 1fr' },
    'kunde',
    'projekt',
    'nettobetrag',
    'mehrwertsteuer',
  ...
  computed: {
    'mwst_betrag': { op: 'mul', left: { kind: 'field', key: 'nettobetrag' }, right: { op: 'div', left: { kind: 'field', key: 'mehrwertsteuer' }, right: { kind: 'literal', value: 100 } } },
