...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    ...
    'datum',
    'stunden',
    { row: ['erfassungsmonat', 'erfassungsjahr'], cols: '1fr 1fr' },
    'abrechenbar',
    'taetigkeit',
  ],
  defaults: {
  ...
  computed: {
    '_eintrag_arbeitshonorar': { op: 'mul', left: { kind: 'applookup', ownKey: 'berater', lookupKey: 'stundensatz' }, right: { kind: 'field', key: 'stunden' } },
  },
};
