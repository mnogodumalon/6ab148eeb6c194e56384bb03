...
export function BeraterDialog({ open, onClose, onSubmit, defaultValues, recordId, leistungskatalogList, projekteList, enablePhotoScan = true, enablePhotoLocation = true }: BeraterDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["stunden_aktueller_monat", "stunden_aktuelles_jahr", "stunden_aktuelles_quartal", "stunden_letzter_monat", "stunden_letztes_jahr", "stunden_letztes_quartal"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'strasse': (
      <div key="strasse" className="space-y-1.5">
        ...
        <Input
          id="strasse"
          placeholder="z. B. Straße der Arbeit 1"
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. max@privatmail.de"
    ...
    'einstiegsdatum': (
      <div key="einstiegsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="einstiegsdatum"
          placeholder="Seit wann ist der Berater aktiv?"
          mode="date"
    ...
    'stunden_aktueller_monat': (
      <div key="stunden_aktueller_monat" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Gebuchte Stunden eingeben"
    ...
    'sonstiges': (
      <div key="sonstiges" className="space-y-1.5">
        ...
        <Textarea
          id="sonstiges"
          placeholder="Weitere Informationen, Qualifikationen, Zertifikate..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <MultiCombobox
          id="leistungen"
          placeholder="Aus Leistungskatalog wählen"
    ...
    'zugewiesene_projekte': (
      <div key="zugewiesene_projekte" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Aktive Projekte zuweisen"
