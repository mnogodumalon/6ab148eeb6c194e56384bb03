...
export function BeraterDialog({ open, onClose, onSubmit, defaultValues, recordId, leistungskatalogList, projekteList, enablePhotoScan = true, enablePhotoLocation = true }: BeraterDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["stunden_aktueller_monat", "stunden_aktuelles_jahr", "stunden_aktuelles_quartal"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. anna@private.de"
    ...
    'einstiegsdatum': (
      <div key="einstiegsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="einstiegsdatum"
          placeholder="Wann ist der Berater eingetreten?"
          mode="date"
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <MultiCombobox
          id="leistungen"
          placeholder="Welche Leistungen kann der Berater erbringen?"
    ...
    'zugewiesene_projekte': (
      <div key="zugewiesene_projekte" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Zu welchen Projekten ist der Berater aktuell zugewiesen?"
