  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email_beruflich': (
      <div key="email_beruflich" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. michael@firma.de"
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. michael@private.de"
    ...
    'einstiegsdatum': (
      <div key="einstiegsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="einstiegsdatum"
          placeholder="Wann ist der Berater eingestiegen?"
          mode="date"
    ...
    'stunden_aktueller_monat': (
      <div key="stunden_aktueller_monat" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Systemfeld, aktualisiert automatisch"
    ...
    'sonstiges': (
      <div key="sonstiges" className="space-y-1.5">
        ...
        <Textarea
          id="sonstiges"
          placeholder="Spezialgebiet, Zertifizierungen, Notizen..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <MultiCombobox
          id="leistungen"
          placeholder="Welche Leistungen bietet dieser Berater?"
    ...
    'zugewiesene_projekte': (
      <div key="zugewiesene_projekte" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Projekte sind zugewiesen?"
