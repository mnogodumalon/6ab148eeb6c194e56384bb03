  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email_beruflich': (
      <div key="email_beruflich" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. anna.schmidt@firma.de"
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. anna@privatmail.de"
    ...
    'stunden_aktueller_monat': (
      <div key="stunden_aktueller_monat" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Übernommen aus Zeiterfassung"
    ...
    'sonstiges': (
      <div key="sonstiges" className="space-y-1.5">
        ...
        <Textarea
          id="sonstiges"
          placeholder="Besonderheiten, Qualifikationen, Hinweise..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <MultiCombobox
          id="leistungen"
          placeholder="Welche Leistungen kann dieser Berater erbringen?"
