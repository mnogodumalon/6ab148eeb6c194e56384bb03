  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="anna.schmidt@privatmail.de"
    ...
    'einstiegsdatum': (
      <div key="einstiegsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="einstiegsdatum"
          placeholder="Wann tritt der Berater bei?"
          mode="date"
    ...
    'stunden_aktueller_monat': (
      <div key="stunden_aktueller_monat" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Erfasste oder berechnete Stunden"
    ...
    'sonstiges': (
      <div key="sonstiges" className="space-y-1.5">
        ...
        <Textarea
          id="sonstiges"
          placeholder="Fachgebiete, Zertifikate, Anmerkungen..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <MultiCombobox
          id="leistungen"
          placeholder="Welche Leistungen beherrscht der Berater?"
    ...
    'zugewiesene_projekte': (
      <div key="zugewiesene_projekte" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Projekte sind aktiv zugewiesen?"
