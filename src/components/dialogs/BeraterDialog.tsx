  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email_beruflich': (
      <div key="email_beruflich" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. anna@inclou.de"
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. anna.schmidt@gmail.com"
    ...
    'einstiegsdatum': (
      <div key="einstiegsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="einstiegsdatum"
          placeholder="Wann ist der Berater beigetreten?"
          mode="date"
    ...
    'sonstiges': (
      <div key="sonstiges" className="space-y-1.5">
        ...
        <Textarea
          id="sonstiges"
          placeholder="Besonderheiten, Spezialisierungen, Notizen..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <MultiCombobox
          id="leistungen"
          placeholder="Welche Leistungen sind zugeordnet?"
