  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email_beruflich': (
      <div key="email_beruflich" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. klaus.mueller@example.com"
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. klaus@private.de"
    ...
    'stunden_aktueller_monat': (
      <div key="stunden_aktueller_monat" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Automatisch aggregiert"
    ...
    'sonstiges': (
      <div key="sonstiges" className="space-y-1.5">
        ...
        <Textarea
          id="sonstiges"
          placeholder="Spezielle Qualifikationen, Notizen..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <MultiCombobox
          id="leistungen"
          placeholder="Welche Leistungen erbringt der Berater?"
    ...
    'zugewiesene_projekte': (
      <div key="zugewiesene_projekte" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Aktuelle Projekte des Beraters"
