  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email_beruflich': (
      <div key="email_beruflich" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. anna.schmidt@inclou.de"
    ...
    'email_privat': (
      <div key="email_privat" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. anna.schmidt@private.de"
    ...
    'stunden_aktueller_monat': (
      <div key="stunden_aktueller_monat" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Automatisch aus Zeiterfassung"
    ...
    'sonstiges': (
      <div key="sonstiges" className="space-y-1.5">
        ...
        <Textarea
          id="sonstiges"
          placeholder="Weitere Anmerkungen, Zertifikate, Sprachen..."
    ...
    'zugewiesene_projekte': (
      <div key="zugewiesene_projekte" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Projekte sind aktuell zugewiesen?"
