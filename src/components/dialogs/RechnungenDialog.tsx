  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechnungsmonat': (
      <div key="rechnungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechnungsmonat" className="max-sm:h-11"><SelectValue placeholder="z. B. März, April" /></SelectTrigger>
          <SelectContent>
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="Wem wird in Rechnung gestellt?"
    ...
    'gesamtbetrag': (
      <div key="gesamtbetrag" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Wird berechnet: Netto + MwSt"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Besonderheiten, Zahlungsbedingungen..."
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Zu welchem Projekt?"
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <MultiCombobox
          id="berater"
          placeholder="Welche Berater haben daran mitgewirkt?"
