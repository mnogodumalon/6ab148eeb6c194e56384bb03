...
export function RechnungenDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, projekteList, beraterList, zeiterfassungList, enablePhotoScan = true, enablePhotoLocation = true }: RechnungenDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["anhang", "gesamtbetrag", "rechnungsnummer", "rechnungsstatus"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'faelligkeitsdatum': (
      <div key="faelligkeitsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann ist der Zahlungstermin?"
          mode="date"
    ...
    'rechnungsmonat': (
      <div key="rechnungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechnungsmonat" className="max-sm:h-11"><SelectValue placeholder="Wähle den Abrechnungsmonat" /></SelectTrigger>
          <SelectContent>
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="Welcher Kunde wird in Rechnung gestellt?"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsbedingungen, Referenzen, Mahnung..."
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Zu welchem Projekt gehört diese Rechnung?"
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Zeiteinträge gehören zu dieser Rechnung?"
