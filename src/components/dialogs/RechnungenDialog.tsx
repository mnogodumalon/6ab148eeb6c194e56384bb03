...
export function RechnungenDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, projekteList, beraterList, zeiterfassungList, enablePhotoScan = true, enablePhotoLocation = true }: RechnungenDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["gesamtbetrag", "rechnungsjahr", "rechnungsmonat", "rechnungsnummer"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechnungsdatum': (
      <div key="rechnungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="rechnungsdatum"
          placeholder="Heute oder anderes Datum?"
          mode="date"
    ...
    'faelligkeitsdatum': (
      <div key="faelligkeitsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Zahlungsfrist in Tagen (z. B. +14 Tage)?"
          mode="date"
    ...
    'rechnungsmonat': (
      <div key="rechnungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechnungsmonat" className="max-sm:h-11"><SelectValue placeholder="Wird automatisch gesetzt" /></SelectTrigger>
          <SelectContent>
    ...
    'nettobetrag': (
      <div key="nettobetrag" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. 10.000,00 (€ ohne Steuern)"
    ...
    'mehrwertsteuer': (
      <div key="mehrwertsteuer" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. 19 (Prozentsatz %)"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsbe­dingungen, Rabatte, Besonderheiten..."
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Aus welchem Projekt stammt diese Rechnung?"
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <MultiCombobox
          id="berater"
          placeholder="Welche Berater sind beteiligt?"
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Zeiteinträge sind hier abgerechnet?"
