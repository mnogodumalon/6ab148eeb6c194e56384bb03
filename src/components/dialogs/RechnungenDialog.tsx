  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechnungsdatum': (
      <div key="rechnungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="rechnungsdatum"
          placeholder="Wann ist die Rechnung erstellt?"
          mode="date"
    ...
    'faelligkeitsdatum': (
      <div key="faelligkeitsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Bis wann muss bezahlt sein?"
          mode="date"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsbedingungen, Hinweise, Referenzen..."
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Zeiteinträge sind in dieser Rechnung enthalten?"
