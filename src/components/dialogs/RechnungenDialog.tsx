...
export function RechnungenDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, projekteList, beraterList, zeiterfassungList, enablePhotoScan = true, enablePhotoLocation = true }: RechnungenDialogProps) {
  ...
  const REQUIRED_FIELDS = ['rechnungsnummer', 'rechnungsdatum', 'kunde', 'projekt'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'faelligkeitsdatum': (
      <div key="faelligkeitsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann ist die Rechnung fällig?"
          mode="date"
    ...
    'rechnungsmonat': (
      <div key="rechnungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechnungsmonat" className="max-sm:h-11"><SelectValue placeholder="Für welchen Monat ist diese Rechnung?" /></SelectTrigger>
          <SelectContent>
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="An welchen Kunden wird die Rechnung gestellt?"
    ...
    'gesamtbetrag': (
      <div key="gesamtbetrag" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Wird automatisch berechnet (Netto + MwSt)"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungskonditionen, Besonderheiten, Referenzen..."
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Zeiteinträge werden abgerechnet?"
