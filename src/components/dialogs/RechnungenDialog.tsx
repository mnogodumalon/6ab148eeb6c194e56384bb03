  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'faelligkeitsdatum': (
      <div key="faelligkeitsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Zahlungsziel wählen"
          mode="date"
    ...
    'rechnungsmonat': (
      <div key="rechnungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechnungsmonat" className="max-sm:h-11"><SelectValue placeholder="Rechnungsmonat wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsbedingungen, Besonderheiten..."
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Für welches Projekt ist die Rechnung?"
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <MultiCombobox
          id="berater"
          placeholder="Beteiligte Berater"
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Gebuchte Stunden zur Rechnung"
