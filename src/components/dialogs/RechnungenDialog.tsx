  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechnungsdatum': (
      <div key="rechnungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="rechnungsdatum"
          placeholder="Heute oder Rechnungsdatum?"
          mode="date"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsbedingungen, Bankverbindung, Besonderheiten..."
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <MultiCombobox
          id="berater"
          placeholder="Beteiligte Berater wählen"
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Zeiteinträge auswählen"
