...
export function RechnungenDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, projekteList, beraterList, zeiterfassungList, enablePhotoScan = true, enablePhotoLocation = true }: RechnungenDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["faelligkeitsdatum", "gesamtbetrag", "rechnungsnummer"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechnungsdatum': (
      <div key="rechnungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="rechnungsdatum"
          placeholder="Wann wurde die Rechnung erstellt?"
          mode="date"
    ...
    'faelligkeitsdatum': (
      <div key="faelligkeitsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Bis wann muss bezahlt werden? (wird berechnet)"
          mode="date"
    ...
    'rechnungsmonat': (
      <div key="rechnungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechnungsmonat" className="max-sm:h-11"><SelectValue placeholder="Für welchen Monat abgerechnet?" /></SelectTrigger>
          <SelectContent>
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="An welchen Kunden die Rechnung?"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsbedingungen, Hinweise, Besonderheiten..."
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Zu welchem Projekt gehört die Rechnung?"
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Zeiten werden abgerechnet?"
