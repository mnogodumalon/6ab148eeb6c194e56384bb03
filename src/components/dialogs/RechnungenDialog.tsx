  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="An welchen Kunden geht die Rechnung?"
    ...
    'mehrwertsteuer': (
      <div key="mehrwertsteuer" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. 19 (für Prozentsatz)"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsbedingungen, Referenzen, Anmerkungen..."
