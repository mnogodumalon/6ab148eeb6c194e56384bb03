...
export function RechnungenDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, projekteList, beraterList, zeiterfassungList, enablePhotoScan = true, enablePhotoLocation = true }: RechnungenDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["gesamtbetrag", "rechnungsnummer", "rechnungsstatus"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'rechnungsdatum': (
      <div key="rechnungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="rechnungsdatum"
          placeholder="Heute oder Ausstellungsdatum"
          mode="date"
    ...
    'faelligkeitsdatum': (
      <div key="faelligkeitsdatum" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Zahlungsfrist (z. B. +14 Tage)"
          mode="date"
    ...
    'rechnungsmonat': (
      <div key="rechnungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="rechnungsmonat" className="max-sm:h-11"><SelectValue placeholder="Abrechnungsmonat wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Zahlungsart, Kontoinformationen, Besonderheiten..."
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Zugehöriges Projekt wählen"
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <MultiCombobox
          id="berater"
          placeholder="Beteiligte Berater hinzufügen"
    ...
    'zeiterfassungseintraege': (
      <div key="zeiterfassungseintraege" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Zeiterfassungseinträge verlinken"
