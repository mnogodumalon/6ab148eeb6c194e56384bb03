  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <Combobox
          id="berater"
          placeholder="Wer hat die Stunden gearbeitet?"
    ...
    'erfassungsmonat': (
      <div key="erfassungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="erfassungsmonat" className="max-sm:h-11"><SelectValue placeholder="Für welchen Abrechnungsmonat?" /></SelectTrigger>
          <SelectContent>
    ...
    'taetigkeit': (
      <div key="taetigkeit" className="space-y-1.5">
        ...
        <Textarea
          id="taetigkeit"
          placeholder="Was wurde gemacht? Beschreibung der Tätigkeiten..."
