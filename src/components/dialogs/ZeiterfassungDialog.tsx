...
export function ZeiterfassungDialog({ open, onClose, onSubmit, defaultValues, recordId, beraterList, projekteList, leistungskatalogList, enablePhotoScan = true, enablePhotoLocation = true }: ZeiterfassungDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["erfassungsjahr", "erfassungsmonat"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <Combobox
          id="berater"
          placeholder="Welcher Berater hat die Stunden geleistet?"
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Auf welches Projekt gehen die Stunden?"
    ...
    'leistung': (
      <div key="leistung" className="space-y-1.5">
        ...
        <Combobox
          id="leistung"
          placeholder="Welche Leistung wurde erbracht? (optional)"
    ...
    'datum': (
      <div key="datum" className="space-y-1.5">
        ...
        <DatePicker
          id="datum"
          placeholder="An welchem Tag war die Tätigkeit?"
          mode="date"
    ...
    'erfassungsmonat': (
      <div key="erfassungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="erfassungsmonat" className="max-sm:h-11"><SelectValue placeholder="Wähle den Abrechnungsmonat" /></SelectTrigger>
          <SelectContent>
    ...
    'taetigkeit': (
      <div key="taetigkeit" className="space-y-1.5">
        ...
        <Textarea
          id="taetigkeit"
          placeholder="Was wurde konkret geleistet? (Aufgaben, Meetings, Code-Reviews...)"
