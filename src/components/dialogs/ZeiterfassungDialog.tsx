  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="In welchem Projekt?"
    ...
    'erfassungsmonat': (
      <div key="erfassungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="erfassungsmonat" className="max-sm:h-11"><SelectValue placeholder="Abrechnungsmonat?" /></SelectTrigger>
          <SelectContent>
    ...
    'taetigkeit': (
      <div key="taetigkeit" className="space-y-1.5">
        ...
        <Textarea
          id="taetigkeit"
          placeholder="Was wurde genau getan? Aufgaben, Ergebnisse, Besonderheiten..."
