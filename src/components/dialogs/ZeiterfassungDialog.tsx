  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'leistung': (
      <div key="leistung" className="space-y-1.5">
        ...
        <Combobox
          id="leistung"
          placeholder="Welche Leistung aus dem Katalog?"
    ...
    'erfassungsmonat': (
      <div key="erfassungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="erfassungsmonat" className="max-sm:h-11"><SelectValue placeholder="In welchem Monat wird abgerechnet?" /></SelectTrigger>
          <SelectContent>
    ...
    'taetigkeit': (
      <div key="taetigkeit" className="space-y-1.5">
        ...
        <Textarea
          id="taetigkeit"
          placeholder="Was wurde konkret geleistet?"
