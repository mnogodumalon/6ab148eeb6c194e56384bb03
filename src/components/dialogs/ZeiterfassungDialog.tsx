  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <Combobox
          id="berater"
          placeholder="Welcher Berater hat die Zeit erfasst?"
    ...
    'datum': (
      <div key="datum" className="space-y-1.5">
        ...
        <DatePicker
          id="datum"
          placeholder="Wann wurde die Arbeit verrichtet?"
          mode="date"
    ...
    'stunden': (
      <div key="stunden" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. 8 (Anzahl Stunden)"
    ...
    'erfassungsmonat': (
      <div key="erfassungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="erfassungsmonat" className="max-sm:h-11"><SelectValue placeholder="z. B. September" /></SelectTrigger>
          <SelectContent>
    ...
    'taetigkeit': (
      <div key="taetigkeit" className="space-y-1.5">
        ...
        <Textarea
          id="taetigkeit"
          placeholder="Beschreibung der durchgeführten Tätigkeiten..."
