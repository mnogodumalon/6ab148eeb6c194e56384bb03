  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="An welchem Projekt wurde gearbeitet?"
    ...
    'datum': (
      <div key="datum" className="space-y-1.5">
        ...
        <DatePicker
          id="datum"
          placeholder="An welchem Tag wurden die Stunden gearbeitet?"
          mode="date"
    ...
    'erfassungsmonat': (
      <div key="erfassungsmonat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="erfassungsmonat" className="max-sm:h-11"><SelectValue placeholder="In welchem Monat werden die Stunden abgerechnet?" /></SelectTrigger>
          <SelectContent>
    ...
    'taetigkeit': (
      <div key="taetigkeit" className="space-y-1.5">
        ...
        <Textarea
          id="taetigkeit"
          placeholder="Was wurde konkret geleistet? Aufgaben, Tätigkeiten..."
