  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projektart': (
      <div key="projektart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektart" className="max-sm:h-11"><SelectValue placeholder="Typ des Projekts" /></SelectTrigger>
          <SelectContent>
    ...
    'projektstart_monat': (
      <div key="projektstart_monat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektstart_monat" className="max-sm:h-11"><SelectValue placeholder="In welchem Monat?" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="Welchen Kunden wählen?"
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Aktueller Stand, nächste Meilensteine, offene Aufgaben..."
