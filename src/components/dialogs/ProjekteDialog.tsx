  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projektart': (
      <div key="projektart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektart" className="max-sm:h-11"><SelectValue placeholder="IT-Beratung, Entwicklung, Schulung?" /></SelectTrigger>
          <SelectContent>
    ...
    'projektstart_monat': (
      <div key="projektstart_monat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektstart_monat" className="max-sm:h-11"><SelectValue placeholder="Wann startet das Projekt?" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'ansprechpartner_kunde': (
      <div key="ansprechpartner_kunde" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Name oder Abteilung"
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Was wurde zuletzt getan, wie geht es weiter..."
    ...
    'projektleitung': (
      <div key="projektleitung" className="space-y-1.5">
        ...
        <Combobox
          id="projektleitung"
          placeholder="Verantwortlicher Berater"
