...
export function ProjekteDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, beraterList, enablePhotoScan = true, enablePhotoLocation = true }: ProjekteDialogProps) {
  ...
  const REQUIRED_FIELDS = ['projektkennung', 'projektnummer', 'projektart', 'projektstatus', 'kunde'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projektart': (
      <div key="projektart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektart" className="max-sm:h-11"><SelectValue placeholder="Welche Art von Projekt?" /></SelectTrigger>
          <SelectContent>
    ...
    'projektstart_monat': (
      <div key="projektstart_monat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektstart_monat" className="max-sm:h-11"><SelectValue placeholder="In welchem Monat startet?" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'ansprechpartner_kunde': (
      <div key="ansprechpartner_kunde" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Hauptansprechpartner beim Kunden?"
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Was wurde zuletzt getan? Wo stehen wir? Nächste Schritte?"
