  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'projektkennung': (
      <div key="projektkennung" className="space-y-1.5">
        ...
        <Input
          id="projektkennung"
          placeholder="Eindeutige Kennung (Auto)"
    ...
    'projektart': (
      <div key="projektart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektart" className="max-sm:h-11"><SelectValue placeholder="Welcher Projekttyp?" /></SelectTrigger>
          <SelectContent>
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Projektstatus, nächste Schritte..."
