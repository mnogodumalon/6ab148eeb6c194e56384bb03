...
export function ProjekteDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, beraterList, enablePhotoScan = true, enablePhotoLocation = true }: ProjekteDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["projektnummer"];
  const [showErrors, setShowErrors] = useState(false);
  const REQUIRED_FIELDS = ['projektkennung', 'projektart', 'projektstatus', 'kunde'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projektart': (
      <div key="projektart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektart" className="max-sm:h-11"><SelectValue placeholder="Projektart wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'projektstart_monat': (
      <div key="projektstart_monat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektstart_monat" className="max-sm:h-11"><SelectValue placeholder="Startmonat wählen" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Aktueller Stand und bisherige Schritte..."
    ...
    'projektleitung': (
      <div key="projektleitung" className="space-y-1.5">
        ...
        <Combobox
          id="projektleitung"
          placeholder="Welcher Berater leitet das Projekt?"
