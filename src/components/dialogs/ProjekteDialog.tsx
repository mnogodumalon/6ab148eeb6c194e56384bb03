  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projektstart_monat': (
      <div key="projektstart_monat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektstart_monat" className="max-sm:h-11"><SelectValue placeholder="z. B. Januar" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Zusammenfassung Projektfortschritt, Meilensteine..."
