  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'projektkennung': (
      <div key="projektkennung" className="space-y-1.5">
        ...
        <Input
          id="projektkennung"
          placeholder="Automatisch vergeben, Read-only"
    ...
    'projektart': (
      <div key="projektart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektart" className="max-sm:h-11"><SelectValue placeholder="Projekttyp wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'projektstart_monat': (
      <div key="projektstart_monat" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektstart_monat" className="max-sm:h-11"><SelectValue placeholder="Startet z. B. im Januar?" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
    ...
    'ansprechpartner_kunde': (
      <div key="ansprechpartner_kunde" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Hr. Müller, Tel. 030 123"
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Was ist der aktuelle Status? Was passiert als nächstes?"
