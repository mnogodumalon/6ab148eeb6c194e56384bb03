  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'projektart': (
      <div key="projektart" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="projektart" className="max-sm:h-11"><SelectValue placeholder="Wähle Projektart" /></SelectTrigger>
          <SelectContent>
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="Für welchen Kunden ist das Projekt?"
    ...
    'ansprechpartner_kunde': (
      <div key="ansprechpartner_kunde" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Hr. Müller, Abt. IT"
    ...
    'letzter_schritt': (
      <div key="letzter_schritt" className="space-y-1.5">
        ...
        <Textarea
          id="letzter_schritt"
          placeholder="Was wurde zuletzt gemacht? Aktueller Stand?"
