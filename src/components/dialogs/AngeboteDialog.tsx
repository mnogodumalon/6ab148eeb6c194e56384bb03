...
export function AngeboteDialog({ open, onClose, onSubmit, defaultValues, recordId, projekteList, beraterList, enablePhotoScan = true, enablePhotoLocation = true }: AngeboteDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["angebotsnummer", "anhang"];
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'zeitrahmen_anfang': (
      <div key="zeitrahmen_anfang" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann startet das Angebot?"
          mode="date"
    ...
    'zeitrahmen_ende': (
      <div key="zeitrahmen_ende" className="space-y-1.5">
        ...
        <DatePicker
          id="zeitrahmen_ende"
          placeholder="Wann endet das Angebot (optional)?"
          mode="date"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was sind Leistungsumfang und Liefergegenstände?"
