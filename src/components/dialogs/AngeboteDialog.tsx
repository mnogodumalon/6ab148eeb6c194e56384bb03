...
export function AngeboteDialog({ open, onClose, onSubmit, defaultValues, recordId, projekteList, beraterList, enablePhotoScan = true, enablePhotoLocation = true }: AngeboteDialogProps) {
  ...
  const SYSTEM_ASSIGNED: string[] = ["angebotsjahr", "angebotsnummer"];
  const [showErrors, setShowErrors] = useState(false);
  const REQUIRED_FIELDS = ['angebotstyp', 'zeitrahmen_anfang'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'zeitrahmen_anfang': (
      <div key="zeitrahmen_anfang" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann soll die Leistung erbracht werden?"
          mode="date"
    ...
    'zeitrahmen_ende': (
      <div key="zeitrahmen_ende" className="space-y-1.5">
        ...
        <DatePicker
          id="zeitrahmen_ende"
          placeholder="Bis wann? (Falls mehrere Tage/Wochen)"
          mode="date"
    ...
    'dauer': (
      <div key="dauer" className="space-y-1.5">
        ...
        <Input
          id="dauer"
          placeholder="z. B. 5 Tage, 2 Wochen"
          value={fields.dauer ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Leistungsumfang, Was ist enthalten? Einschränkungen?"
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Welches Projekt ist betroffen?"
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <Combobox
          id="berater"
          placeholder="Welcher Berater führt es durch?"
