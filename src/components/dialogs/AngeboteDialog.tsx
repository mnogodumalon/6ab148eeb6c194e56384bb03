...
export function AngeboteDialog({ open, onClose, onSubmit, defaultValues, recordId, projekteList, beraterList, enablePhotoScan = true, enablePhotoLocation = true }: AngeboteDialogProps) {
  ...
  const REQUIRED_FIELDS = ['angebotsnummer', 'angebotsjahr', 'angebotstyp', 'zeitrahmen_anfang'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'dauer': (
      <div key="dauer" className="space-y-1.5">
        ...
        <Input
          id="dauer"
          placeholder="z. B. 4 Wochen, 10 Arbeitstage"
          value={fields.dauer ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was genau wird in diesem Angebot geleistet? Scope, Liefergegenstände, Annahmen.."
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <Combobox
          id="berater"
          placeholder="Welcher Berater ist verantwortlich?"
