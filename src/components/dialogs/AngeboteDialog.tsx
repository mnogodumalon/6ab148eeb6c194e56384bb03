  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'zeitrahmen_anfang': (
      <div key="zeitrahmen_anfang" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann beginnt die Leistung?"
          mode="date"
    ...
    'zeitrahmen_ende': (
      <div key="zeitrahmen_ende" className="space-y-1.5">
        ...
        <DatePicker
          id="zeitrahmen_ende"
          placeholder="Wann endet die Leistung? (optional)"
          mode="date"
    ...
    'dauer': (
      <div key="dauer" className="space-y-1.5">
        ...
        <Input
          id="dauer"
          placeholder="z. B. 3 Monate, 12 Wochen"
          value={fields.dauer ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Leistungsumfang, Bedingungen, Annahmen..."
    ...
    'projekt': (
      <div key="projekt" className="space-y-1.5">
        ...
        <Combobox
          id="projekt"
          placeholder="Zu welchem Projekt gehört das Angebot?"
    ...
    'berater': (
      <div key="berater" className="space-y-1.5">
        ...
        <Combobox
          id="berater"
          placeholder="Welcher Berater ist zuständig?"
