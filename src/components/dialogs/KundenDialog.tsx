  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email': (
      <div key="email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. kontakt@techcorp.de"
          value={fields.email ?? ''}
    ...
    'anlagedatum': (
      <div key="anlagedatum" className="space-y-1.5">
        ...
        <DatePicker
          id="anlagedatum"
          placeholder="Wann wurde der Kunde registriert?"
          mode="date"
    ...
    'ansprechpartner_email': (
      <div key="ansprechpartner_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. max@techcorp.de"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Kundenhistorie, Besonderheiten, Vereinbarungen..."
