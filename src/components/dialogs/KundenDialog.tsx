  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'kundenname': (
      <div key="kundenname" className="space-y-1.5">
        ...
        <Input
          id="kundenname"
          placeholder="z. B. Firma Schmidt GmbH"
    ...
    'anlagedatum': (
      <div key="anlagedatum" className="space-y-1.5">
        ...
        <DatePicker
          id="anlagedatum"
          placeholder="Wann wurde der Kunde hinzugefügt?"
          mode="date"
    ...
    'ansprechpartner_email': (
      <div key="ansprechpartner_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. hans.mueller@example.com"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Besonderheiten, Präferenzen, Anmerkungen..."
