  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'email': (
      <div key="email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. info@mueller.de"
          value={fields.email ?? ''}
    ...
    'ansprechpartner_email': (
      <div key="ansprechpartner_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          inputMode="email"
          placeholder="z. B. max@mueller.de"
    ...
    'letzter_kontakt_ansprechpartner': (
      <div key="letzter_kontakt_ansprechpartner" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Wer war der Ansprechpartner?"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Besonderheiten, Vereinbarungen, Notizen..."
