  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'leistungsname': (
      <div key="leistungsname" className="space-y-1.5">
        ...
        <Input
          id="leistungsname"
          placeholder="z. B. IT-Beratung Standard"
    ...
    'leistungstyp': (
      <div key="leistungstyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="leistungstyp" className="max-sm:h-11"><SelectValue placeholder="Wähle einen Leistungstyp" /></SelectTrigger>
          <SelectContent>
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was ist enthalten? Welche Leistungen, Ergebnisse, Besonderheiten?"
    ...
    'ausfuehrende_berater': (
      <div key="ausfuehrende_berater" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Berater führen diese Leistung aus?"
