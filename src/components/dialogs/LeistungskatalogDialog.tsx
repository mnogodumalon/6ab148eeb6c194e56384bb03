  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'leistungstyp': (
      <div key="leistungstyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="leistungstyp" className="max-sm:h-11"><SelectValue placeholder="Welcher Leistungstyp?" /></SelectTrigger>
          <SelectContent>
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Leistungsumfang, Besonderheiten, Voraussetzungen..."
