  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'leistungstyp': (
      <div key="leistungstyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="leistungstyp" className="max-sm:h-11"><SelectValue placeholder="Art der Leistung" /></SelectTrigger>
          <SelectContent>
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was ist enthalten? Was wird geleistet?"
    ...
    'ausfuehrende_berater': (
      <div key="ausfuehrende_berater" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Wer führt diese Leistung aus?"
