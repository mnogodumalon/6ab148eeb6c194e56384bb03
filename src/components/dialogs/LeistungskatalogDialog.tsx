  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'leistungsname': (
      <div key="leistungsname" className="space-y-1.5">
        ...
        <Input
          id="leistungsname"
          placeholder="z. B. Oracle-Implementierung"
    ...
    'leistungstyp': (
      <div key="leistungstyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="leistungstyp" className="max-sm:h-11"><SelectValue placeholder="z. B. Beratung, Entwicklung" /></SelectTrigger>
          <SelectContent>
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Kurzbeschreibung, Umfang, Besonderheiten..."
    ...
    'ausfuehrende_berater': (
      <div key="ausfuehrende_berater" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Aus den Beratern wählen"
