  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'leistungsname': (
      <div key="leistungsname" className="space-y-1.5">
        ...
        <Input
          id="leistungsname"
          placeholder="z. B. Angular-Schulung"
    ...
    'leistungstyp': (
      <div key="leistungstyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="leistungstyp" className="max-sm:h-11"><SelectValue placeholder="z. B. Schulung, Beratung, Entwicklung" /></SelectTrigger>
          <SelectContent>
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was umfasst diese Leistung? Umfang, Dauer, Besonderheiten..."
