  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'leistungsname': (
      <div key="leistungsname" className="space-y-1.5">
        ...
        <Input
          id="leistungsname"
          placeholder="z. B. IT-Sicherheitsberatung"
    ...
    'leistungstyp': (
      <div key="leistungstyp" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="leistungstyp" className="max-sm:h-11"><SelectValue placeholder="Welche Art von Leistung?" /></SelectTrigger>
          <SelectContent>
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was umfasst diese Leistung, welche Zwischenschritte...?"
    ...
    'kostenvoranschlag': (
      <div key="kostenvoranschlag" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. 2500 (für die Einheit)"
    ...
    'ausfuehrende_berater': (
      <div key="ausfuehrende_berater" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Welche Berater können diese Leistung erbringen?"
