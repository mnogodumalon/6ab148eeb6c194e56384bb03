  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'leistungsname': (
      <div key="leistungsname" className="space-y-1.5">
        ...
        <Input
          id="leistungsname"
          placeholder="z. B. SAP-Beratung, Coaching"
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Was ist enthalten? Dauer? Umfang?"
    ...
    'kostenvoranschlag': (
      <div key="kostenvoranschlag" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. 150,00 (€/Einheit)"
    ...
    'ausfuehrende_berater': (
      <div key="ausfuehrende_berater" className="space-y-1.5">
        ...
        <MultiCombobox
          ...
          placeholder="Wer führt diese Leistung durch?"
