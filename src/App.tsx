...
const IntentProjektstatusAktualisierenPage = lazy(() => import('@/pages/intents/ProjektstatusAktualisierenPage'));
const IntentKundeAnlegenPage = lazy(() => import('@/pages/intents/KundeAnlegenPage'));
// </custom:imports>
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/projektstatus-aktualisieren" element={<Suspense fallback={<DashboardSkeleton />}><IntentProjektstatusAktualisierenPage /></Suspense>} />
                <Route path="intents/kunde-anlegen" element={<Suspense fallback={<DashboardSkeleton />}><IntentKundeAnlegenPage /></Suspense>} />
                {/* </custom:routes> */}
