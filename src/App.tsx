...
const IntentRechnungAnlegenPage = lazy(() => import('@/pages/intents/RechnungAnlegenPage'));
// </custom:imports>
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/rechnung-anlegen" element={<Suspense fallback={<DashboardSkeleton />}><IntentRechnungAnlegenPage /></Suspense>} />
                {/* </custom:routes> */}
